...
module Radiant
  ...
  class Initializer < Rails::Initializer
    ...
    def initialize_default_admin_tabs
      admin.tabs.clear
      admin.tabs.add I18n.t('pl.tabs.pages'),    "/admin/pages"
      admin.tabs.add I18n.t('pl.tabs.snippets'), "/admin/snippets"
      admin.tabs.add I18n.t('pl.tabs.layouts'),  "/admin/layouts", :visibility => [:admin, :developer]
    end
